...
if (isset($_GET['p_id']) && $_GET['p_id'] != '') {
    ...
    $level1 = $data['uplevel'];
    $level1Open = '<li class="breadcrumb-item"><a href="allproducts_menu.php?classid=' . $level1Upclassid . '&level=' . $level1 . '">' . $level1Cname . '</a></li>';
    //處理第二層
    $level2Cname = $data['cname'];
    $level2Classid = $data['classid'];
    $level2Open = '<li class="breadcrumb-item"><a href="allproducts_menu.php?classid=' . $level2Classid . '">' . $level2Cname . '</a></li>';
    //處理第三層
    ...
    $level1Cname = $data['cname'];
    $level1 = $data['level'];
    $level1Open = '<li class="breadcrumb-item"><a href="allproducts_menu.php?classid=' . $level2Uplink . '&level=' . $level1 . '">' . $level1Cname . '</a></li>';
}
?>
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index_p01.php">首頁</a></li>
        <li class="breadcrumb-item <?= $level1Open == '' ? 'active' :'' ; ?>"><a href="allproducts_menu.php">產品一覽</a></li>
