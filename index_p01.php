    ...
    <section class="container-fluid">
        ...
        <div class="row">
            <div class="container-fluid brand ">
                <div class="d-flex col-md-10 my-5 mx-auto container">
                    <div class="col-8">
                    ...
                    <div class="col-4 to-animate opacity-0" data-animation="animate__zoomIn" data-delay="animate__delay-2s"><img src="./images/brand.jpg" alt="" class="img-fluid ps-1"></div>
                </div>
            </div>
            <div class="row products ">
                <div class="my-5">
                    <h4 class="text-center">產品展示</h4>
                    <hr class="my-5">
                    <div>
            ...
            <div id="last-data" class="row text-center">
                ...
                <div class="col-sm-3">
                    ...
                    <div class="icon d-flex justify-content-evenly">
                        ...
                        <a href="#"><p><i class="fab fa-line"></i></p></a>
                        <a href="#"><p><i class="fab fa-youtube"></i></p></a>
                    </div>
                </div>
                <div class="col-sm-3">
                    <h4>訂閱電子報</h4>
